...
- (ZXCaptureDevice *)device {
  ...
  if (!zxd) {
    ...
    NSError *error = nil;
    if ([zxd isFocusModeSupported:AVCaptureFocusModeContinuousAutoFocus] && [zxd lockForConfiguration:&error]) {
        [zxd setFocusMode:AVCaptureFocusModeContinuousAutoFocus];
