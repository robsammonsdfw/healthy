...
/// Note, This was copied from: https://github.com/KennethTsang/GrowingTextView
/// Because there was an unfixed issue in the Cocoapod.
/// TODO: In the future, migrate back to cocoapod when the setNeedsLayout() call
/// is added per this issue: https://github.com/KennethTsang/GrowingTextView/issues/57.
@IBDesignable @objc
open class GrowingTextView: UITextView {
    ...
    @objc public func forceLayoutSubviews() {
        oldSize = .zero
        setNeedsLayout()
        layoutIfNeeded()
    }
