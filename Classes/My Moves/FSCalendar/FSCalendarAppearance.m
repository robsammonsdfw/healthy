...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _backgroundColors = [[NSMutableDictionary dictionaryWithCapacity:5] retain];
        ...
        _titleColors = [[NSMutableDictionary dictionaryWithCapacity:5] retain];
        ...
        _subtitleColors = [[NSMutableDictionary dictionaryWithCapacity:5] retain];
