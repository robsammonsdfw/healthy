...
#import "GetUPCNameDataWebService.h"
#import "DietmasterEngine.h"
#import "JSON.h"

@implementation GetUPCNameDataWebService
...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error
{
	...
	if ([delegate respondsToSelector:@selector(getUPCNameDataWSFailed:)]) {
        [delegate getUPCNameDataWSFailed:[error localizedDescription]];
    }
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	if ([delegate respondsToSelector:@selector(getUPCNameDataWSFinished:)]) {
        [delegate getUPCNameDataWSFinished:responseDict];
    }
